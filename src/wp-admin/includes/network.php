...
function network_step2( $errors = false ) {
	...
	$document_root_fix = isset( $_SERVER['DOCUMENT_ROOT'] ) ? str_replace( '\\', '/', realpath( wp_unslash( $_SERVER['DOCUMENT_ROOT'] ) ) ) : '';
	$abspath_fix       = str_replace( '\\', '/', ABSPATH );
	$home_path         = ( '' !== $document_root_fix && str_starts_with( $abspath_fix, $document_root_fix ) ) ? $document_root_fix . $base : get_home_path();
